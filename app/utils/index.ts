 ...
 * @param string token
 */
export const setLocalStorage = (token: string, key: string = __TOKEN__) => sessionStorage.setItem(key, token);

/**
 * 模块名:获取缓存
 */
export const getLocalStorage = (key: string = __TOKEN__) => sessionStorage.getItem(key);

/**
 * 模块名: 移除token
 */
export const moveLocalStorageToken = () => sessionStorage.removeItem(__TOKEN__);
